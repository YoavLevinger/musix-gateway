...
public final class Constants {
    ...
    /**
     * A constant field to represent the language.
     */
    public static final String LYRICS_LANGUAGE = "f_lyrics_language";

    /**
     * A constant field to represent the max date of a track.
     */
    public static final String TRACK_RELEASE_GROUP_FIRST_RELEASE_DATE_MAX = "f_track_release_group_first_release_date_max";

    /**
     * A constant field to represent the Album ID.
     */
